    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {   
                ...
                float shadowmap = EvaluateThickness(shadowContext, _ShadowmapCascadeAtlas, s_linear_clamp_compare_sampler, posSS, IN.posWS, normalWS_geom, lightData.shadowIndex, lightDir, unusedSplitIndex);
                
                float3 col = shadowmap;
                return half4(col, 1);
            }
            ENDHLSL
        }
